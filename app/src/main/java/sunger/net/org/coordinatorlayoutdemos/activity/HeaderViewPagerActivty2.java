 ...
 */
public class HeaderViewPagerActivty2 extends FragmentActivity implements SwipeRefreshLayout.OnRefreshListener, AppBarLayout.OnOffsetChangedListener, ScrollFeedbackRecyclerView.Callbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_header_viewpager2);
...
//            tab.select();
        ...
        findViewById(R.id.relativeLayout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HeaderViewPagerActivty1.this, "relativeLayout", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//        toolbar.setAlpha(alpha);
    ...
    public boolean isAppBarCollapsed() {
        ...
        boolean isAppBarCollapsed = appBarVisibleHeight == mTabLayout.getHeight();
        Log.i("aaaaaaaaaa", "isAppBarCollapsed " + isAppBarCollapsed);
        return isAppBarCollapsed;
    }

    @Override
    public void setExpanded(final boolean expanded) {
        Log.i("aaaaaaaaaa", "setExpanded ");
